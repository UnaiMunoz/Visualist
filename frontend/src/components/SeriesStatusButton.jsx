// frontend/src/components/SeriesStatusButton.jsx
...
import SeriesStatusModal from "./SeriesStatusModal";

const SeriesStatusButton = ({ contentId, contentType, seriesTitle }) => {
...
export default SeriesStatusButton;
